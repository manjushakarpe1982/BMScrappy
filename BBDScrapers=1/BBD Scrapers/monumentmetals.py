...
def parse_product_page(driver_source, url, CP_Id, CompPriceScraperLogId,BBDProductId):
    ...
    goldSpotPrice = '//*[@class="priceBar-priceContainer-390 h-10 lg_h-12.5 m-0 flex justify-center sticky top-0 z-50 bg-white lg_items-center"]/div[1]/span[2]/text()'
    silverSpotPrice = '//*[@class="priceBar-priceContainer-390 h-10 lg_h-12.5 m-0 flex justify-center sticky top-0 z-50 bg-white lg_items-center"]/div[2]/span[2]/text()'
    platinumSpotPrice = '//*[@class="priceBar-priceContainer-390 h-10 lg_h-12.5 m-0 flex justify-center sticky top-0 z-50 bg-white lg_items-center"]/div[3]/span[2]/text()'
    palladiumSpotPrice = '//*[@class="priceBar-priceContainer-390 h-10 lg_h-12.5 m-0 flex justify-center sticky top-0 z-50 bg-white lg_items-center"]/div[4]/span[2]/text()'
    ...
    try:
        ...
        silverspotprice = parsed_page.xpath(silverSpotPrice)[0].strip()
        platinumspotprice = parsed_page.xpath(platinumSpotPrice)[0].strip()
        palladiumspotprice = parsed_page.xpath(palladiumSpotPrice)[0].strip()
