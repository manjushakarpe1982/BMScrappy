...
competitorName = 'Silver Gold Bull'
groupName = ""
driver = None
...
logfile_path = 'Scraper logs/silvergoldbull.log'
website_code = 'SG'
...
def parse_product_page(driver_source, url, CP_Id, CompPriceScraperLogId,BBDProductId):
    ...
    # goldSpotPrice = '//*[@class="navbar-first container-fluid no-padding d-none d-lg-block"]//span[@class="market_indicator gold_market_indicator"]/div/div/strong/text()'
    # silverSpotPrice = '//*[@class="navbar-first container-fluid no-padding d-none d-lg-block"]//span[@class="market_indicator silver_market_indicator"]/div/div/strong/text()'
    # platinumSpotPrice = '//*[@class="navbar-first container-fluid no-padding d-none d-lg-block"]//span[@class="market_indicator platinum_market_indicator"]/div/div/strong/text()'
    # palladiumSpotPrice = '//*[@class="navbar-first container-fluid no-padding d-none d-lg-block"]//span[@class="market_indicator palladium_market_indicator"]/div/div/strong/text()'
    ...
    try:
        ...
        base_qty_rows = parsed_page.xpath(priceTable+'/tbody/tr[contains(@class, "tier-row")]')
...
def close_modal():
    ...
    # Close modal
    try:
        shh_modal_close = driver.find_element_by_xpath('//a[contains(@id, "close-wisepop")]')
...
def select_max_results_option():
    try:
        ...
        dropdown_button = driver.find_element_by_xpath('//div[contains(@class, "category-paginator")]/div')
        dropdown_button.click()
        sleep(5)
        # click 50 results link
        sixty_results_link = driver.find_element_by_xpath('//div[contains(@class, "category-paginator")]//ul[contains(@class, "dropdown-menu")]/li/a[@data-flare-rows="50"]')
        sixty_results_link.click()
        # Scoll to page result numbers to make elements visible
        #scroll_to_element = driver.find_element_by_id('page-announce')
