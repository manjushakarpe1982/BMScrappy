...
competitorName = 'wholesalecoinsdirect'
...
logfile_path = 'Scraper logs/wholesalecoinsdirect.log'
website_code = 'WS'
...
def parse_product_page(driver_source, url, CP_Id, CompPriceScraperLogId,BBDProductId):
    ...
    try:
        ...
        #     label = detail.xpath('./th/text()')[0].strip()
        #     value = detail.xpath('./td/text()')[0].strip()
