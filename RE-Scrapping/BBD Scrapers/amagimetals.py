...
def parse_product_page(driver_source, url, CP_Id, CompPriceScraperLogId,BBDProductId):
    ...
    try:
        ...
        base_qty_rows = parsed_page.xpath(priceTable+'/tbody/tr[not(@style)]')
        ...
        presale = 0
        availability = 1 if 'In stock' in parsed_page.xpath(IsAvailable)[0] else 0
        outofstock = 1 if 'Out of stock' in parsed_page.xpath(IsAvailable)[0] else 0
        discontinued = 0
