...
#DB_CONNECTION = pyodbc.connect('DRIVER={SQL Server};SERVER=172.106.161.81;DATABASE=BMProd;UID=sa;PWD=Ash@2011$D')
...
COMPETITOR_SOURCE_FILE_PATH =  "C:\\Users\Rahul\PycharmProjects\BBD Scrapers"